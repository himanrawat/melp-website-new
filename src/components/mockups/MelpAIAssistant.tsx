			...
			<div className="p-4 min-h-[220px] space-y-4">
				...
				<AnimatePresence>
					{showResponse && (
						...
						>
							<div className="flex items-start gap-2 max-w-[85%]">
								<div className="w-6 h-6 rounded-lg bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center shrink-0">
			...
			<div className="p-3 border-t border-gray-800 bg-[#242424]">
				<div className="flex items-center gap-2 bg-[#1a1a1a] rounded-lg px-3 py-2">
					<input
						...
						readOnly
					/>
					<button className="w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center">
