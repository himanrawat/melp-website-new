      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Placeholder description about accessing Melp from any device, anywhere.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="hidden lg:flex flex-col items-center">
            ...
            <Badge variant="secondary" className="mt-3">Tablet</Badge>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <Badge variant="secondary" className="mt-3">Desktop</Badge>
          </div>
          ...
          <div className="flex flex-col items-center -ml-8 sm:-ml-12 lg:-ml-16 z-10">
            ...
            <Badge variant="secondary" className="mt-3">Mobile</Badge>
          </div>
        </motion.div>
