...
const productHighlights = [
  {
    ...
    description: "This is a placeholder description for the first product highlight panel.",
  },
  {
    title: "Feature Highlight 2",
    description: "This is a placeholder description for the second product highlight panel.",
  },
  {
    title: "Feature Highlight 3",
    description: "This is a placeholder description for the third product highlight panel.",
  },
  {
    title: "Feature Highlight 4",
    description: "This is a placeholder description for the fourth product highlight panel.",
  },
];
    ...
    <section className="bg-muted/30">
      ...
      <div ref={containerRef} className="hidden md:block relative h-[300vh]">
        <div className="sticky top-0 h-screen overflow-hidden flex items-center">
          ...
          <motion.div
            style={{ x }}
            className="flex gap-8 pl-[10vw] pt-20"
          >
            {productHighlights.map((item, index) => (
              <motion.div
                key={index}
